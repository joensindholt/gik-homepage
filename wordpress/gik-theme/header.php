...
<head>
  ...
  <link rel="stylesheet" href="<?php echo get_bloginfo('template_directory'); ?>/style.css?v=2">
  ...
  <script src="<?php echo get_bloginfo('template_directory'); ?>/scripts/app.js?v=6"></script>
</head>
